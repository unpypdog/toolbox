...
def run():
    with sync_playwright() as p:
        ...
        # Test 5b: Fourth card links to share info
        fourth_link = cards.nth(3).get_attribute("href")
        if fourth_link != "./tools/share-info/index.html":
            errors.append(f"Card 3: expected href './tools/share-info/index.html', got '{fourth_link}'")
        else:
            print(f"[OK] Card 3 → tools/share-info/index.html")
